...
public class GlobalActionsPowerDialog {
    ...
    public static Dialog create(@NonNull Context context, MultiListAdapter adapter) {
        final ViewGroup view = (ViewGroup) LayoutInflater.from(context).inflate(
                com.android.systemui.res.R.layout.global_actions_grid_lite, null);

        final MultiListLayout multiListLayout = view.findViewById(com.android.systemui.res.R.id.global_actions_view);
        multiListLayout.setAdapter(adapter);

        final View overflowButton = view.findViewById(com.android.systemui.res.R.id.global_actions_overflow_button);
